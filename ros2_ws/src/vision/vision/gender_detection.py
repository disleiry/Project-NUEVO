...
# Adience Dataset constants (Crucial for accuracy)
MODEL_MEAN_VALUES = (78.4263377603, 87.7689143744, 114.895847746)
GENDER_LIST = ['Male', 'Female']

class GenderDetector:
    def __init__(self):
        # Load TensorFlow Face model
    ...
    def detect(self, frame):
        ...
        # Step 1: Detect the face in the photo
        ...
        for i in range(detections.shape[2]):
            ...
            if confidence > 0.8:  # High threshold for static images
