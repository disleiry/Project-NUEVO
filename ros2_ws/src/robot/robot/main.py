...
PURE_PURSUIT_CONTROL_POINTS = [
    ...
    (760.0, 740.0),     # Waypoint 3: ramp / return direction
...
LIFT_CARRY_TICKS = -13400
LIFT_PICKUP_TICKS = -8500
LIFT_ITEM_THICKNESS_TICKS_1 = -2100
LIFT_ITEM_THICKNESS_TICKS_2 = -1500
