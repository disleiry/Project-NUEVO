...
PURE_PURSUIT_CONTROL_POINTS = [
    #(0.0, 0.0),        # start
    (100.0, 3850.0),      # Waypoint 1: home straight
    (640.0, 3850.0),    # Waypoint 2: transition / turn
    (760.0, 750.0),     # Waypoint 3: ramp / return direction
...
PURE_PURSUIT_CONTROL_POINTS_2 = [
    ...
    (1900.0, 3750.0),
    (2000.0, 3750.0),
    (2250.0, 3750.0),    # Waypoint 2: transition / turn
...
LIFT_PICKUP_TICKS = -8000
LIFT_ITEM_THICKNESS_TICKS_1 = -1800
LIFT_ITEM_THICKNESS_TICKS_2 = -1200
